...
export default function ChatCoach() {
    ...
    return (
        <div style={{ margin: '20px', marginLeft: '100px', marginRight: '100px', textAlign: 'center' }}>
            <div className="card mt-2">
                <form onSubmit={async (e) => {
                    ...
                    setChatResponse(response);
                        ...
                        <input  type="text" className="form-control" name="question" placeholder="Ask chat gourmand a food related question... (ex: What should I eat ? What did i eat in the last 8 meals ? Can I a slice of cake ?)" onChange={(e) => setQuestion(e.target.value)} value={question} />
                ...
                <div className="d-flex justify-content-center align-items-center" style={{ minHeight: '10vh' }}>
                  <div className="spinner-border text-primary" role="status">
                    ...
                    <h5 style={{ marginBottom: '25px' }} className="card-title">le Chat Gourmand is ready</h5>
                )}
