...
export default function FoodCard({ params }: { params: { id: number, name: string, average_calories: number, times_eaten: number } }) {
    if (!params) {
        ...
        <div>
            <div className="card" style={{ width: '18rem', margin: '10px' }}>
                <div className="card-body" style={{ border: '5px solid #ccc', borderRadius: '5px', padding: '10px', textAlign: 'center' }}>
                    ...
                    <p className="card-text">Average Calories: {params.average_calories}</p>
